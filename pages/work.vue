	...
	<div class="mb-3 mt-2">
		...
		<div class="p-5 md:p-10 bg-gradient-to-r from-blue-50 to-indigo-50 w-full rounded-lg shadow-lg mb-8">
			<div class="flex items-center mb-2">
				<div class="bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold mr-3">Current</div>
				<span class="text-sm font-medium text-gray-500">January 2025 – May 2025</span>
			</div>
