  ...
  data () {
    return {
      ...
      jobs: [
        ...
        { title: 'Reekadia Records', role: 'Web Developer', date: 'Feb – Sep 2026', url: 'https://www.reekadiarecords.com/', category: 'Music',
          desc: "Official site for Afrobeats artist Reekado Banks and his label, Reekadia Records. Nine routes covering music, videos, tour, merch, and booking enquiries. Scroll-linked featured-release section with an animated vinyl, a rotating hero, a career-milestone timeline, and a glassmorphic design system carried across every page.",
        ...
        { title: 'Spotlighthub', role: 'Fullstack Developer', date: 'Jun 2025', url: 'https://spotlighticket.com', category: 'E-commerce',
          desc: 'Ticketing marketplace for events, movies, and venues across Nigeria. Instant QR-code tickets, Paystack, Flutterwave, and Stripe checkout, cancellations up to 24 hours before an event, and an organiser dashboard with real-time sales tracking and fast payouts.',
          tags: ['Ticketing', 'Paystack', 'Flutterwave', 'Stripe', 'QR Codes', 'Dashboard'] },
