<template>
  <div class="work-page">
    ...
    <div class="projects-section">
      <div class="section-label">// hobby projects</div>
      <h3 class="section-title font-bold">Built for Fun</h3>
        ...
        <div class="project-card-body">
          <div class="project-header">
            <div class="project-meta">
              <span class="project-badge font-mono">Personal</span>
              <span class="project-lang font-mono">PHP · Laravel</span>
            </div>
            <a href="https://github.com/jerryisuwamakeri/ott" target="_blank" rel="noreferrer" class="project-gh-link" aria-label="View on GitHub">
          ...
          <h4 class="project-name font-black">OTT — Online Trade Terminal</h4>
          <p class="project-desc">A global marketplace where every order is handled personally by a real admin. No automated checkout — buyers chat directly with admins, sellers receive crypto payouts.</p>
          <ul class="tl-bullets">
            <li>Admin-mediated order flow with real-time messaging via Laravel Reverb / WebSockets</li>
            <li>Bitcoin order payments with live rate tracking + Flutterwave subscription billing</li>
            <li>Three-role system: Buyers, Sellers, Admins — each with scoped dashboards</li>
            <li>Revenue export, printable receipts, email notifications, and verification badges</li>
          </ul>
          <div class="tl-tags" style="margin-top:14px;">
            ...
            <span class="tag">Flutterwave</span>
          </div>
        </div>
      </div>
    </div>
