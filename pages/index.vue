<template>
  <div class="min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-0 pt-20 pb-20 md:pt-0 md:pb-0">
    <div class="flex justify-center py-2 absolute top-0 left-0 right-0">
      <menu-links />
    </div>
    <div class="w-full max-w-2xl">
      <div class="w-32 h-32 sm:w-40 sm:h-40 rounded-full mx-auto shadow-lg mb-4 sm:mb-6 overflow-hidden flex-shrink-0">
      ...
      <h3 class="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight break-words">Hello, I am Makeri Jerry Isuwa</h3>
      <p class="text-base sm:text-lg md:text-xl text-gray-600 mt-2 sm:mt-4 break-words">A Fullstack Software Developer | AWS Cloud Engineer and IT Consultant</p>
      <p class="text-sm sm:text-base text-gray-500 mt-3 sm:mt-4 break-words">I don't just write code; I architect digital experiences that solve real-world problems. My passion lies in transforming complex ideas into elegant, user-centric software.</p>
      <nuxt-link class="text-xs sm:text-sm font-medium inline-flex items-center text-gray-500 mt-4 sm:mt-6 hover:text-gray-700 transition-colors" :to="{ name: 'about'}">
        Read more about me
