  ...
  <div class="h-screen flex justify-center items-center text-center">
    ...
    <div class="container mx-3">
      <div class="w-40 h-40 rounded-full mx-auto shadow mb-3 overflow-hidden">
        ...
        <img class="object-cover object-center w-full h-48 rounded-full shadow" src="/image.jpg" alt="Makeri Jerry Isuwa">
      </div>
      <h3 class="text-3xl font-extrabold">Hello, I am Makeri Jerry Isuwa</h3>
      <p class="text-xl text-gray-600">A Fullstack Software Developer | AWS Cloud Engineer and IT Consultant</p>
      <p class="text-base text-gray-500 mt-2 max-w-2xl mx-auto">I don't just write code; I architect digital experiences that solve real-world problems. My passion lies in transforming complex ideas into elegant, user-centric software.</p>
      <nuxt-link class="text-xs font-medium inline-flex items-center text-gray-500 mt-3" :to="{ name: 'about'}">
        Read more about me
